...
export const openSourceContributions = [
  {
    ...
    location: "Remote",
    highlights: [
      "6+ PRs merged across multiple repositories",
      "Tree planted via Trees for Tribals by Tree-Nation",
      "Verified Digital Badges on Holopin",
      "Subscriptions from DigitalOcean, Appwrite & more",
    ],
  },
];
